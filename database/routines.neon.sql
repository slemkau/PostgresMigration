...
alter function public.query_select_application_logs(timestamp, timestamp, varchar, integer) OWNER TO neondb_owner;
...
alter function public.query_select_activity_logs(varchar, timestamp, timestamp, varchar, integer) OWNER TO neondb_owner;
...
alter function public.query_select_sendgrid_logs(timestamp, timestamp, varchar, integer) OWNER TO neondb_owner;
...
alter function public.ins_upd_activity_log(varchar, varchar, varchar, varchar, varchar, integer, integer, varchar, timestamp, jsonb, jsonb) OWNER TO neondb_owner;
...
alter function public.ins_upd_sendgrid_log(uuid, varchar, timestamp, varchar, varchar, varchar, varchar, varchar, text, varchar, varchar, varchar, varchar, jsonb, jsonb, jsonb, varchar) OWNER TO neondb_owner;
...
alter procedure public.upd_attachment_log(uuid, varchar, bytea) OWNER TO neondb_owner;
...
alter function public.query_select_audit_logs(varchar, timestamp, timestamp, varchar, varchar, integer) owner to neondb_owner;
