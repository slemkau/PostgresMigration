create sequence public.api_service_catalog_service_catalog_key_seq
    as integer;

alter sequence public.api_service_catalog_service_catalog_key_seq owner to postgres;
...
create sequence public.api_service_contract_service_contract_key_seq
    as integer;

alter sequence public.api_service_contract_service_contract_key_seq owner to postgres;
...
create sequence public.application_log_log_item_key_seq
    as integer;

alter sequence public.application_log_log_item_key_seq owner to postgres;
...
create sequence public.sendgrid_template_email_template_key_seq
    as integer;

alter sequence public.sendgrid_template_email_template_key_seq owner to postgres;
...
alter sequence public.sendgrid_log_email_item_key_seq owner to postgres;
...
create sequence public.html_body_log_html_item_key_seq
    as integer;

alter sequence public.html_body_log_html_item_key_seq owner to postgres;
...
create sequence public.parmgrid_log_parm_item_key_seq
    as integer;

alter sequence public.parmgrid_log_parm_item_key_seq owner to postgres;
...
create sequence public.post_address_log_post_item_key_seq
    as integer;

alter sequence public.post_address_log_post_item_key_seq owner to postgres;
...
create sequence public.attachment_log_attach_item_key_seq
    as integer;

alter sequence public.attachment_log_attach_item_key_seq owner to postgres;
...
create sequence public.sendgrid_messages_msg_key_seq
    as integer;

alter sequence public.sendgrid_messages_msg_key_seq owner to postgres;
...
create sequence public.sendgrid_events_event_key_seq
    as integer;

alter sequence public.sendgrid_events_event_key_seq owner to postgres;
...
create sequence public.sendgrid_event_details_event_detail_key_seq
    as integer;

alter sequence public.sendgrid_event_details_event_detail_key_seq owner to postgres;
